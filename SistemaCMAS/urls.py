...
from PortalCMAS.views import Index, MembresiasUsuarios, Login, FormRegistro, Clases_cliente, Clases_profesor, Comunidad, Contactos, Inscripcion, RegistroEntrada, Metricas_clientes, Login_Admin, Crear_Clase, Ver_Clase, Actualizar_Clase, Eliminar_Clase, MembresiasAdmin, CrearMembresias, Eliminar_Membresia, Actualizar_Membresia

urlpatterns = [
    path('', Index),
    path('Membresias/', MembresiasUsuarios),
    path('PortalLogin/', Login),
    path('PortalRegistro/', FormRegistro, name="PortalRegistro"),
